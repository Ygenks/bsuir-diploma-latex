\section{ТЕХНИКО-ЭКОНОМИЧЕСКОЕ ОБОСНОВАНИЕ РАЗРАБОТКИ СИСТЕМЫ ОБРАБОТКИ ВИДЕОПОТОКА}
\label{sec:economics}
...
% Система рассчитана на применение в различных отраслях, но особенно хорошо проявляет себя при обработке
% видео выского разрешения с жёсткими требованиями на скорость обработки и низкое энергопотребление,
% таких как машиностроение, авиастроение, космическая промышленность и разработка \en{embedded} устройств.
...
спроектированную систему на базе любой микросхемы FPGA седьмой серии компании Xilinx.

% Если будет мало текста, то можно впихнуть сюда стоиомсть минимально рабочей платы
